      ...
      <div className={styles.inner}>
        ...
        <div className={styles.actions}>
          ...
          <button type="button" className={styles.cartBtn} aria-label="Carrito" onClick={onOpenCart}>
            ...
            <svg className={styles.cartIcon} width="23" height="23" viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <path d="M8.5 9V7a3.5 3.5 0 0 1 7 0v2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
              <path d="M5.6 8.4h12.8a.6.6 0 0 1 .6.66l-.92 10.5A2.2 2.2 0 0 1 15.9 21.6H8.1a2.2 2.2 0 0 1-2.18-2.04L5 9.06a.6.6 0 0 1 .6-.66z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
