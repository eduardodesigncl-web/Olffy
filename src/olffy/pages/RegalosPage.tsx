...
export function RegalosPage({ products, giftProducts, onProductClick }: RegalosPageProps) {
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <Flower className={`${styles.deco} ${styles.decoFlower}`} color="var(--olffy-naranjo)" size={62} />
        ...
        <div className={styles.heroInner}>
          ...
          <p className={styles.subtitle}>
            Kits curados, papelería ilustrada y detalles especiales para regalar con cariño.
          </p>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <ProductGrid products={giftProducts} onProductClick={onProductClick} />
      </section>
      </div>
    </div>
  );
